...
internal sealed class AcceptSystemManagerInvitationCommandValidator
    : AbstractValidator<AcceptSystemManagerInvitationCommand>
{
    public AcceptSystemManagerInvitationCommandValidator()
    {
