...
namespace AgriDrone.Database.Migrations
{
    ...
    [Migration("20260820121655_CompleteMappingMessagingFlow")]
    partial class CompleteMappingMessagingFlow
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("tenant_invitations", "identity", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_tenant_invitations_role_not_owner", "role <> 'OWNER'::system.tenant_member_role");
                        });
                });
