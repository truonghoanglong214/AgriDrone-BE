...
namespace AgriDrone.Database.Migrations
{
    ...
    [Migration("20260813092356_Phase6OfflineHarvestAudit")]
    partial class Phase6OfflineHarvestAudit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgriDrone.Modules.Plants.Domain.Conditions.ConditionDetection", b =>
                {
                    ...
                    b.HasIndex("ReviewStatus")
                        .HasDatabaseName("ix_condition_detections_review");
            ...
            modelBuilder.Entity("AgriDrone.Modules.Plants.Domain.Conditions.ConditionDetection", b =>
                {
                    ...
                    b.HasOne("AgriDrone.Modules.Identity.Domain.Users.User", null)
                        ...
                        .HasForeignKey("ReviewedBy")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_condition_detections_users_reviewed_by");
